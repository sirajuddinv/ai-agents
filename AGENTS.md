...
| Git Repository Initialization | [`.agents/skills/git_repo_initialization/SKILL.md`](.agents/skills/git_repo_initialization/SKILL.md) | User asks to initialize a new repo, set up Git LFS, or bring an existing directory under version control |
