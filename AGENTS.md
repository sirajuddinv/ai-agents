...
| Git Cross-Repository Cherry-Pick | [`.agents/skills/git_cross_repo_cherry_pick/SKILL.md`](.agents/skills/git_cross_repo_cherry_pick/SKILL.md) | User asks to cherry-pick or move commits between unrelated local repositories or submodules |
...
| Python Venv Repair | [`.agents/skills/python_venv_repair/SKILL.md`](.agents/skills/python_venv_repair/SKILL.md) | Python venv commands fail with `bad interpreter` or symlink errors, or venv base interpreter is missing |
...
| GitHub Workflow Creation | [`.agents/skills/github_workflow_creation/SKILL.md`](.agents/skills/github_workflow_creation/SKILL.md) | Protocol for creating CI/CD workflows with atomic script separation, access control, and optimized deployment patterns |
...
| VS Code User Settings Symlink | [`.agents/skills/vscode_user_settings_symlink/SKILL.md`](.agents/skills/vscode_user_settings_symlink/SKILL.md) | Relocate VS Code Insiders User folder to configurations-private with direct symlink |
...
| Git Submodule Fork Reconfigure | [`.agents/skills/git_submodule_fork_reconfigure/SKILL.md`](.agents/skills/git_submodule_fork_reconfigure/SKILL.md) | Operational protocol for forking submodules on the fly and reconfiguring remotes |
