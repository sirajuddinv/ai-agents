...
- **Biological/System Identifiers**: Replace any user-specific path prefix (e.g., `/Users/X/`) with a redacted
  placeholder: `[REDACTED]`.
- **Environmental Context**: If a path must be specific but is sensitive, replace it with a descriptive
  placeholder: `[USER_PROVIDED_PATH]`.
...
2. **Redact**: Replace sensitive identifiers with `[REDACTED]`.
