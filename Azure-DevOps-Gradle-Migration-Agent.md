...
- **Reference**: See `GitHub-Actions-rules.md` > **Workflow Structure and Configuration** for naming conventions, triggers, and permissions.
- **Key Actions**:
...
- **Strategy**:
    ...
    - **Dynamic Setup**: Use the **Conditional Java Setup** strategy defined in the rules. This ensures robustness and saves time by using pre-installed versions where possible.
